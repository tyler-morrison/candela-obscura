  ...
  return (
    <main className="homePage">
      <header className="homePage-header">
        <img
          className="homePage-header-hero"
          src="/images/marketing-hero.png"
          alt="Two investigators stand within the center of an ominous cavern. Their three companions appear injured off to the side, struggling to stand. In the background, a gigantic eldritch monster looms overhead, its giant beaky opens to emit an ear-piercing screech."
        />
        <img
          className="homePage-header-logo"
          src="/images/co-logo.webp"
          alt=""
          role="presentation"
        />
        <h1 className="sr-only">Candela Obscura Online</h1>
      </header>
      <section className="homePage-aboutSection">
        <h2 className="homePage-aboutSection-heading">The Fairelands Await</h2>
        <p>
          Build your digital character sheet, join a circle, and begin your
